...
const text = "Bem-vindo ao meu portfólio! Aqui estão meus trabalhos, redes sociais e resultados reais. Quer fechar parceria ou colaboração? Clica no botão abaixo e bora conversar.";
  let i = 0;
  function typing() {
    if (i < text.length) {
